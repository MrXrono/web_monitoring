...
class Controller(Base):
    ...
    host_interface: Mapped[str | None] = mapped_column(String(32))
    product_name: Mapped[str | None] = mapped_column(String(256))
    supported_raid_levels: Mapped[dict | None] = mapped_column(JSONB)
    next_cc_launch: Mapped[str | None] = mapped_column(String(64))
    next_pr_launch: Mapped[str | None] = mapped_column(String(64))
    next_battery_learn: Mapped[str | None] = mapped_column(String(64))
    ecc_bucket_count: Mapped[int] = mapped_column(Integer, default=0)
    firmware_package_build: Mapped[str | None] = mapped_column(String(64))
