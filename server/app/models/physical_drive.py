...
class PhysicalDrive(Base):
    ...
    link_speed: Mapped[str | None] = mapped_column(String(32))
    device_speed: Mapped[str | None] = mapped_column(String(32))
    physical_sector_size: Mapped[str | None] = mapped_column(String(16))
