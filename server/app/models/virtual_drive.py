...
class VirtualDrive(Base):
    ...
    active_operations: Mapped[str | None] = mapped_column(String(64))
    write_cache: Mapped[str | None] = mapped_column(String(64))
    span_depth: Mapped[int | None] = mapped_column(Integer)
